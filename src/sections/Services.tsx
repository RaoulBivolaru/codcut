...
const ServiceItem: FC<ServiceItemProps> = props => {
  ...
  return (
    <div className="py-5 px-6 border-2 border-accent text-white flex-grow text-xl lg:text-2xl rounded-xl text-center w-full lg:w-auto bg-shade">
      <h3>{title}</h3>
    </div>
  );
};
...
export default () => {
  return (
    <section className="px-10 py-10 bg-gray" id="services">
      <div className="container mx-auto">
        <div className="flex lg:gap-10 justify-start items-start flex-col">
          <div className="py-10 font-light text-lg w-full">
            <h2 className="text-white text-4xl lg:text-5xl font-bold tracking-wide mb-10">IT Services & Solutions</h2>
