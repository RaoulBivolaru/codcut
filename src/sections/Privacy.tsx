...
export default function () {
  return (
    <section className="pt-52 px-10 pb-10">
      <h1 className="text-white text-6xl font-bold tracking-wide mb-5 ">
        Privacy Policy
      </h1>
      <p className="text-content">
        codcut (“we,” “our,” or “us”) is committed to protecting your privacy.
        This Privacy Policy explains how your personal information is collected,
        used, and disclosed by codcut. This Privacy Policy applies to our
        website/apps, and its associated subdomains (collectively, our
        “Service”) alongside our application, codcut. By accessing or using our
      ...
      <ul className="list-disc pl-5">
        <li className="text-content">
          Cookie: small amount of data generated by a website/apps and saved by
        ...
        <li className="text-content">
          ...
          refers to codcut, that is responsible for your information under this
          Privacy Policy.
        </li>
        <li className="text-content">
          Country: where codcut or the owners/founders of codcut are based, in
          this case is Romania
        </li>
        <li className="text-content">
          Customer: refers to the company, organization or person that signs up
          to use the codcut Service to manage the relationships with your
          consumers or service users.
        </li>
        <li className="text-content">
          Personnel: refers to those individuals who are employed by codcut or
        ...
        <li className="text-content">
          Service: refers to the service provided by codcut as described in the
      ...
      <p className="text-content">
        We collect information from you when you visit our website/apps,
      ...
      <p className="text-content">
        codcut will collect End User Data necessary to provide the codcut
      ...
      <p className="text-content">
        ...
        in becoming a codcut customer, we receive information from a third party
        that provides automated fraud detection services to codcut. We also
      ...
      <p className="text-content">
        ...
        and the website/apps, database storage and management, e-mail
        management, storage marketing, credit card processing, customer service
        and fulfilling orders for products and services you may purchase through
        the website/apps. We will likely share your personal information, and
      ...
      <p className="text-content">
        ...
        such as connection speed, whether you have visited the website/apps in a
        shared location, and type of the device used to visit the website/apps.
        They may aggregate information about our advertising and what you see on
        the website/apps and then provide auditing, research and reporting for
      ...
      <ul className="list-disc pl-5">
        ...
        <li className="text-content">
          To improve our apps (we continually strive to improve our apps
      ...
      <p className="text-content">
        By submitting your email address on this website/apps, you agree to
      ...
      <p className="text-content">
        We keep your information only so long as we need it to provide codcut to
      ...
      <p className="text-content">
        ...
        any information you transmit to codcut or guarantee that your
      ...
      <p className="text-content">
        codcut is incorporated in Romania. Information collected via our
        website/apps, through direct interactions with you, or from use of our
      ...
      <p className="text-content">
        ...
        codcut collects depend on your relationship with codcut. Personnel may
        update or correct their information as detailed in our internal company
        employment policies. Customers have the right to request the restriction
        of certain uses and disclosures of personally identifiable information
        as follows. You can contact us in order to (1) update or correct your
        personally identifiable information, (2) change your preferences with
        respect to communications and other information you receive from us, or
        (3) delete the personally identifiable information maintained about you
        on our systems (subject to the following paragraph), by cancelling your
      ...
      <p className="text-content">
        ...
        the assets of codcut or any of its Corporate Affiliates (as defined
        herein), or that portion of codcut or any of its Corporate Affiliates to
      ...
      <p className="text-content">
        ...
        codcut, whether by ownership or otherwise. Any information relating to
      ...
      <p className="text-content">
        ...
        under Privacy Shield, or the Swiss-US framework. The laws of Romania,
        excluding its conflicts of law rules, shall govern this Agreement and
        your use of the website/apps. Your use of the website/apps may also be
        subject to other local, state, national, or international laws. By using
        codcut or contacting us directly, you signify your acceptance of this
        Privacy Policy. If you do not agree to this Privacy Policy, you should
        not engage with our website/apps, or use our services. Continued use of
        the website/apps, direct engagement with us, or following the posting of
      ...
      <p className="text-content">
        ...
        being used. By using our codcut, registering an account, or making a
      ...
      <p className="text-content">
        ...
        contain links to other websites not operated or controlled by codcut. We
        ...
        you use a link to go from the Services to another website/apps, our
        Privacy Policy is no longer in effect. Your browsing and interaction on
        any other website/apps, including those that have a link on our
      ...
      <p className="text-content">
        codcut uses "Cookies" to identify the areas of our website/apps that you
        ...
        performance and functionality of our website/apps but are non-essential
        ...
        login details every time you visit the website/apps as we would not be
        ...
        Cookies, you may not be able to access functionality on our website/apps
      ...
      <p className="text-content">
        ...
        cookies and prevent our website/apps from functioning properly, and you
      ...
      <p className="text-content">
        ...
        acknowledge and agree that codcut shall not be responsible for any
        ...
        or any other aspect thereof. codcut does not assume and shall not have
      ...
      <p className="text-content">
        ...
        At codcut we strongly believe that your data privacy is very important
      ...
      <p className="text-content">
        ...
        requirements of GDPR. codcut processes or stores all personal data in
      ...
      <p className="text-content">
        ...
        are also required to communicate information about rights California
      ...
      <p className="text-content">
        ...
        Personal Information we have collected about you. Right to Equal
        Service. We will not discriminate against you if you exercise your
        privacy rights. Right to Delete. You may submit a verifiable request to
        close your account and we will delete Personal Information about you
        that we have collected. Request that a business that sells a consumer's
      ...
      <p className="text-content">
        ...
        it, which we have explained above. CalOPPA users have the following
        rights:
      </p>
      <p className="text-content">
        Right to Know and Access. You may submit a verifiable request for
        ...
        privacy rights. Right to Delete. You may submit a verifiable request to
        close your account and we will delete Personal Information about you
        that we have collected. Right to request that a business that sells a
