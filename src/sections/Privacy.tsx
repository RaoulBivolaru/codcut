  ...
  return (
    <section className="pt-52 px-10 pb-10">
      ...
      <p className="text-content">
        raoul.tech (“we,” “our,” or “us”) is committed to protecting your
        privacy. This Privacy Policy explains how your personal information is
        collected, used, and disclosed by raoul.tech. This Privacy Policy
        applies to our website/apps, and its associated subdomains
        (collectively, our “Service”) alongside our application, raoul.tech. By
      ...
      <ul className="list-disc pl-5">
        ...
        <li className="text-content">
          ...
          refers to raoul.tech, that is responsible for your information under
          this Privacy Policy.
        </li>
        <li className="text-content">
          Country: where raoul.tech or the owners/founders of raoul.tech are
          based, in this case is Romania
        </li>
        <li className="text-content">
          Customer: refers to the company, organization or person that signs up
          to use the raoul.tech Service to manage the relationships with your
          consumers or service users.
        </li>
        <li className="text-content">
          Personnel: refers to those individuals who are employed by raoul.tech
        ...
        <li className="text-content">
          Service: refers to the service provided by raoul.tech as described in
      ...
      <h2 className="text-3xl font-bold text-white mt-10">
        When does raoul.tech use end user information from third parties?
      </h2>
      <p className="text-content">
        raoul.tech will collect End User Data necessary to provide the
        raoul.tech services to our customers. End users may voluntarily provide
        us with information they have made available on social media websites.
      ...
      <h2 className="text-3xl font-bold text-white mt-10">
        When does raoul.tech use customer information from third parties?
      </h2>
      <p className="text-content">
        ...
        in becoming a raoul.tech customer, we receive information from a third
        party that provides automated fraud detection services to raoul.tech. We
      ...
      <p className="text-content">
        ...
        raoul.tech to you and fulfill the purposes described in this policy.
      ...
      <p className="text-content">
        ...
        any information you transmit to raoul.tech or guarantee that your
      ...
      <p className="text-content">
        raoul.tech is incorporated in Romania. Information collected via our
      ...
      <h2 className="text-3xl font-bold text-white mt-10">
        Is the information collected through the raoul.tech Service secure?
      </h2>
      <p className="text-content">
      ...
      <p className="text-content">
        ...
        raoul.tech collects depend on your relationship with raoul.tech.
        ...
        identifiable information as follows. You can contact us in order to (1)
        update or correct your personally identifiable information, (2) change
        your preferences with respect to communications and other information
      ...
      <p className="text-content">
        ...
        the assets of raoul.tech or any of its Corporate Affiliates (as defined
        herein), or that portion of raoul.tech or any of its Corporate
      ...
      <p className="text-content">
        ...
        raoul.tech, whether by ownership or otherwise. Any information relating
      ...
      <p className="text-content">
        ...
        raoul.tech or contacting us directly, you signify your acceptance of
        this Privacy Policy. If you do not agree to this Privacy Policy, you
        should not engage with our website/apps, or use our services. Continued
        use of the website/apps, direct engagement with us, or following the
      ...
      <p className="text-content">
        ...
        being used. By using our raoul.tech, registering an account, or making a
      ...
      <p className="text-content">
        ...
        raoul.tech. We are not responsible for the content, accuracy or opinions
        ...
        website/apps, our Privacy Policy is no longer in effect. Your browsing
        and interaction on any other website/apps, including those that have a
      ...
      <p className="text-content">
        raoul.tech uses "Cookies" to identify the areas of our website/apps that
        ...
        the performance and functionality of our website/apps but are
        ...
        website/apps as we would not be able to remember that you had logged in
        ...
        functionality on our website/apps correctly or at all. We never place
      ...
      <p className="text-content">
        ...
        acknowledge and agree that raoul.tech shall not be responsible for any
        ...
        or any other aspect thereof. raoul.tech does not assume and shall not
      ...
      <p className="text-content">
        ...
        At raoul.tech we strongly believe that your data privacy is very
      ...
      <p className="text-content">
        ...
        requirements of GDPR. raoul.tech processes or stores all personal data
