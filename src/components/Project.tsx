  ...
  return (
    <a
      ...
      <article className="w-full h-96 relative flex justify-center items-end rounded-xl overflow-hidden">
        ...
        <div className="absolute transition-height text-center text-white h-28 font-heading tracking-wider relative px-5 group-hover:h-full w-full backdrop-blur-sm bg-shade/30 flex flex-col justify-center">
